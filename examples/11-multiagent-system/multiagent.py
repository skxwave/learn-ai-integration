...
def summarizer_node(state: State):
    """Summarize conversation history to prevent context overflow."""
    ...
    # Keep only the last 3 messages and store summary
    return {"messages": state["messages"][-3:], "summary": summary}
